...
const InputsCheckBox = ({id, value, onClick, label}) => {
  ...
  return (
    <label className='text-white mr-2 flex w-60 h-10 items-center justify-between px-3  hover:bg-card-contraste cursor-pointer rounded-lg' htmlFor={`${id}CheckboxOrcamento`}>
      {label}
      <input
